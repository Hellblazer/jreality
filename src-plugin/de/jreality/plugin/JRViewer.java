...
import de.jreality.plugin.menu.PostProcessingHelperMenu;
...
public class JRViewer {
	...
	private View // view plugin
		view = new View();
	private static RunningEnvironment
		env;
	private ViewPreferences // viewPreferences plugin
	 ...
	 * This is also loaded by default
	 * @param s the scene
	 */
	public JRViewer(JrScene s) {
		...
		c.registerPlugin(new ToolSystemPlugin()); // input and tool interaction manager
	...
	public void addBasicUI() {
		...
		c.registerPlugin(new PostProcessingHelperMenu());
	}
	...
	public void addVRSupport() {
		c.registerPlugin(new Avatar()); // add first person view, controls
