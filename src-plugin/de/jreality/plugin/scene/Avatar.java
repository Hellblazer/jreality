...
/**
 * This is the plugin that is called when VRsupport is added. It is responsible for the first person controls.
 * it consists of a shipnavigation + a headrotation component.
 * 
 * @author unknown
 *
 */
public class Avatar extends Plugin implements ChangeListener {
	...
	private void updateComponents(Scene scene) {
		avatar = scene.getAvatarComponent(); // this is how the avatar is linked to the scene
