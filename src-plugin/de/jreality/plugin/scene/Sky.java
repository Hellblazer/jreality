...
/**
 * this creates a subpanel in the VR controlls to interact with the skybox
 * comment: padilla
 *
 */
public class Sky extends Plugin implements UIFlavor {
	...
	private static String[][] defaultSkyBoxes = {
		...
		{"GridBox","textures/GridBox/grid_", sideNames, ".jpeg",},
		//adding hd skyboxes
		{"Clouds","textures/bluecloud/bluecloud_", sideNames, ".jpg",},
		{"Sunny","textures/TropicalSunnyDay/TropicalSunnyDay2048_", sideNames, ".png",},
		{"Sunset","textures/ThickCloudsWater/ThickCloudsWater2048_", sideNames, ".png",},
