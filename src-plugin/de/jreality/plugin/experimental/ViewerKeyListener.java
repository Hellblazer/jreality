...
/**
 * viewer specific listener of every key that was hard coded here. calls render after every press
 * @author Charles Gunn
 *
 */
@Experimental
	...
	public void keyPressed(KeyEvent e)	{
			...
			switch(e.getKeyCode())	{
				...
				case KeyEvent.VK_C:		// select a color
					Color color = ColorConverter.toJR(JColorChooser.showDialog((Component) viewer.getViewingComponent(), "Select background color",  null));
					if (color == null) break;
					if (e.isShiftDown())	
