...
import de.jreality.ui.DefaultJRTextures;
...
public class ContentAppearance extends SceneShrinkPanel implements ColorPickerModeChangedListener {
	...
	public ContentAppearance() {
		textures = DefaultJRTextures.getDefaultTextures();
	...
	public void restoreStates(Controller c) throws Exception {
		...
		appearanceInspector.setPointColor(Color.toColor(c.getProperty(getClass(), "pointColor", DEFAULT_POINT_COLOR)));
		appearanceInspector.setPointLabelColor(Color.toColor(c.getProperty(getClass(), "pointLabelColor", DEFAULT_POINT_LABEL_COLOR)));
		...
		appearanceInspector.setLineColor(Color.toColor(c.getProperty(getClass(), "lineColor", DEFAULT_LINE_COLOR)));
		appearanceInspector.setLineLabelColor(Color.toColor(c.getProperty(getClass(), "lineLabelColor", DEFAULT_LINE_LABEL_COLOR)));
		...
		appearanceInspector.setFaceColor(Color.toColor(c.getProperty(getClass(), "faceColor", DEFAULT_FACE_COLOR)));
		appearanceInspector.setFaceLabelColor(Color.toColor(c.getProperty(getClass(), "faceLabelColor", DEFAULT_FACE_LABEL_COLOR)));
