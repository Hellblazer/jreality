...
public class ColorChooseJButton extends JButton implements ActionListener{
	...
	public void paint(Graphics g) {
		...
		g2d.setPaint(new GradientPaint(0, 0, getBackground(), 0, getHeight(), ColorConverter.toAwt(actColor)));
		g2d.fillRoundRect(5, 3, getWidth() - 12, getHeight() - 8, 7, 7);
		g2d.setColor(ColorConverter.toAwt(actColor.darker()));
	...
	public void actionPerformed(ActionEvent e) {
		...
		Color newColor = ColorConverter.toJR(JColorChooser.showDialog(w, title, ColorConverter.toAwt(color)));
		if (newColor != null){
			color = newColor;
