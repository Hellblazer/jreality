...
/**
 * carries matrices, screen dimensions, lights and helpers.
 * give this object to rendering functions for reference.
 * comment: padilla
 *
 */
public class JOGLRenderState {
	...
	/**
	 * create a new render state with most settings given by the parent state. Good for graph strucutre 
	 * @param parentState
	 * @param matrix
	 */
