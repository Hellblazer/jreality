...
public class JOGLSceneGraphComponentInstance extends SceneTreeNode {
	...
	/**
	 * simply combines a JOGLGeometryInstance with the renderState
	 * commment: padilla
	 *
	 */
	...
	/**
	 * recursively goes through the scene graph and collects transparent and non-tr. in distinct lists 
	 * @param parentState
	 * @param ruc
	 * @param transpObjects
	 */
